...
export default async function TenantAdminDashboard({ params }: TenantAdminPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Organization Dashboard</h2>
          <p className="text-gray-600">Manage your {tenantName} settings, users, and module configurations</p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-600">CRM, LMS, HRM, POS</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-600">Admin, Manager, Employee, Guest, Custom</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-600">Slack, Google Workspace</p>
              </div>
